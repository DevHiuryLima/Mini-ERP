...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/05/2025 às 23:31
...
CREATE TABLE `cupons` (
  ...
  `minimo_subtotal` decimal(10,2) NOT NULL DEFAULT 0.00,
...
ALTER TABLE `estoques`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `estoques_produto_id_variacao_unique` (`produto_id`,`variacao`);
...
ALTER TABLE `itens_pedido`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `itens_pedido_pedido_id_produto_id_variacao_unique` (`pedido_id`,`produto_id`,`variacao`),
...
ALTER TABLE `pedidos`
  ...
  ADD KEY `pedidos_cupom_id_foreign` (`cupom_id`);
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_cupom_id_foreign` FOREIGN KEY (`cupom_id`) REFERENCES `cupons` (`id`) ON DELETE SET NULL;
COMMIT;
